...
**E3 — VALIDITY OF THE MEASURE ITSELF IS NOW IN QUESTION (negative result, FINDINGS §25).
Read this before building anything further on `dev_k`.** A planted-structure test (synthetic
...
0.38 / 0.45 at K=3 against 0.33 — even when 90% of generated ties are within-community. The
driver is degree sparsity in the real data: live-entity total degree has median 2, and
**44–45% of live entities have total degree ≤ 1** across all active relations. Fitted
