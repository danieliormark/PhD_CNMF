...
| `LCS/masked_corpus_v2.previous/`, `LCS/masked_corpus_v2.run2103/` and the matching `.previous` and `.run2103` copies of `citation_dictionary_v2.jsonl`, `citation_marks_v2.jsonl`, `superscript_residuals_v2.jsonl`, `citation_masking_v2_summary.json` | The first (20:54) and second (21:03) full runs of P1 v2, superseded by the run of 21:23 (RL-054); kept until deletion is approved |
